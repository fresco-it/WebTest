...
Marca con `[x]` lo incluido en la primera versión. Las rutas sin marcar son opcionales o posteriores.

## Páginas principales

- [x] `/` — Inicio
- [x] `/servicios` — Listado de servicios (una sola página en v1; ver `CONTENIDO_PAGINAS.md`)
...
## Opcional (post-v1 o si se acuerda explícitamente)

- [ ] `/blog` o `/noticias`
- [ ] `/presupuesto` o landing específica
- [ ] Otras rutas: (anotar aquí)
